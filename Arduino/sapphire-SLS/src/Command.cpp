...
bool CommentMode_bool_Command;//注释模式标志位
...
void Get_Command()
{
	...
	*/
	//MYSERIAL.println("Get_Command()"); // 输出信息
	...
	if (Command_Key('G')) {
		...
		case 1:
			...
			if (Command_Key('Z')) {
				...
				MYSERIAL.println("hasZcode");
				MYSERIAL.println(GCodeVal_floatArry_Command[2]);
			}
			...
			if (Command_Key('X')) {
				...
				MYSERIAL.println("hasXcode");
				MYSERIAL.println(GCodeVal_floatArry_Command[0]);
			}
			...
			if (Command_Key('Y')) {
				...
				NeedMove_boolArry_Command[0] = true;
				MYSERIAL.println("hasYcode");
				MYSERIAL.println(GCodeVal_floatArry_Command[1]);
			}
			// 如果命令中有'A'键，那么设置GCodeVal_floatArry_Command[3]为KeyVal_struct.F的值，并将NeedMove_boolArry_Command[3]设为真
				...
				MYSERIAL.println("hasAcode");
				MYSERIAL.println(GCodeVal_floatArry_Command[3]);
			}
			// 如果命令中有'B'键，那么设置GCodeVal_floatArry_Command[4]为KeyVal_struct.F的值，并将NeedMove_boolArry_Command[4]设为真
				...
				MYSERIAL.println("hasBcode");
				MYSERIAL.println(GCodeVal_floatArry_Command[4]);
			}
			// 如果命令中有'C'键，那么设置GCodeVal_floatArry_Command[5]为KeyVal_struct.F的值，并将NeedMove_boolArry_Command[5]设为真
				...
				MYSERIAL.println("hasCcode");
				MYSERIAL.println(GCodeVal_floatArry_Command[5]);
			}
			break;
		case 90:
			// 如果KeyVal_struct.F的值为90，那么打印"start"
			MYSERIAL.println("startTTTTTTTTTTT");
			break;
		}
