...
#define SPEED_SERIAL 115200 // 定义串口通信的波特率为250000
...
#define STEPPER_A_TIMER Timer3 // 定义步进电机A使用的定时器为Timer4
...
#define STEPPER_B_TIMER Timer3 // 定义步进电机B使用的定时器为Timer4
...
#define STEPPER_C_TIMER Timer3 // 定义步进电机C使用的定时器为Timer4
...
#define DA_VAL_ARRY_SIZE 3000 // 定义DA值数组的大小为6000，表示每个DA值可以存储6000个数字量
...
#define HEATING_TIMER Timer3 // 定义加热器使用的定时器为Timer6
